...
def synthesize_clifford_layered(
    cliff: Clifford,
...
def synthesize_clifford_depth_lnn(cliff):
    ...
    """
    circ = synthesize_clifford_layered(
        cliff,
...
synth_clifford_layers = synthesize_clifford_layered
synth_clifford_depth_lnn = synthesize_clifford_depth_lnn
