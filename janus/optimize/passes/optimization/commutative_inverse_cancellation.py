...
class CommutativeInverseGateCanceller(TransformationPass):
    ...
    def cancel_inverse_gates(self, dag: DAGCircuit):
        """
        Run the CommutativeInverseGateCanceller pass on `dag`.
    ...
    def run(self, dag: DAGCircuit):
        """Alias for cancel_inverse_gates() to maintain backward compatibility.
        ...
        Returns:
            DAGCircuit: Transformed DAG.
        """
        return self.cancel_inverse_gates(dag)


# Backward compatibility alias
CommutativeInverseCancellation = CommutativeInverseGateCanceller
