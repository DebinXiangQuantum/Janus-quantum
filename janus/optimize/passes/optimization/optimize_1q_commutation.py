...
class SingleQubitCommutationOptimizer(TransformationPass):
    """
    ...
    def optimize_with_commutation(self, dag):
        """Run the SingleQubitCommutationOptimizer pass on `dag`.
    ...
    def run(self, dag):
        """Alias for optimize_with_commutation() to maintain backward compatibility.
        ...
        Returns:
            DAGCircuit: the optimized DAG.
        """
        return self.optimize_with_commutation(dag)


# Backward compatibility alias
Optimize1qGatesSimpleCommutation = SingleQubitCommutationOptimizer
