...
class TemplateCircuitSubstitutor:
    """
    ...
    def __init__(self, max_matches, circuit_dag_dep, template_dag_dep, user_cost_dict=None):
        """
        Initialize TemplateCircuitSubstitutor with necessary arguments.
        Args:
    ...
    def substitute_and_optimize(self):
        """
    ...
    def run_dag_opt(self):
        """Alias for substitute_and_optimize() to maintain backward compatibility.

        It runs the substitution algorithm and creates the optimized DAGCircuit().
        """
        return self.substitute_and_optimize()


# Backward compatibility alias
TemplateSubstitution = TemplateCircuitSubstitutor
