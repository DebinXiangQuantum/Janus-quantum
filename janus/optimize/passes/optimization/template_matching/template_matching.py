...
class TemplatePatternMatcher:
    """
    Class TemplatePatternMatcher allows to apply the full template matching algorithm.
    """
    ...
    def __init__(
        ...
        """
        Create a TemplatePatternMatcher object with necessary arguments.
        Args:
    ...
    def run_template_matching(self):
        """Alias for find_pattern_matches() to maintain backward compatibility.
        ...
        are stored. Finally, the list of stored matches is sorted.
        """
        return self.find_pattern_matches()


# Backward compatibility alias
TemplateMatching = TemplatePatternMatcher
